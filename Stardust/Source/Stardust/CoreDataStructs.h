...
public:
	...
	static const FWienerProcessData* GetWienerProcess(EResourceType ResourceType);
...
private:
	...
	static UDataTable* WienerProcessDataTable;
};
...
UDataTable* UStructDataLibrary::WienerProcessDataTable = nullptr;
...
USTRUCT()
struct FWienerProcessData : public FTableRowBase
{
	GENERATED_BODY()
...
public:
	...
	float WorldDemand;
	UPROPERTY(EditAnywhere)
	TMap<EResourceType, float> CorrelatedProcesses;
};
